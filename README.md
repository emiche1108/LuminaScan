...
アプリケーション開発に際して、需要予測の分野に興味がありましたが<br>
個人での開発や検証が難しく、より身近なテーマ でデータ活用の実践ができないかと考えた結果<br>
「肌の状態を画像解析技術を用いて数値化し、客観的に分析する」ことに着目し、Lumina Scan の開発に至りました。<br>
<br>
アプリケーション制作を通じて、画像解析やデータ分析の基礎を学びながら、<br>
将来的にはAIを活用し、より高度な肌診断技術の実現を目指しています。<br>
また、自身のプログラマーとしての適性を試し、新しい技術に挑戦する機会にしたいと考えています。<br>

このプロジェクトを通じて、AIの活用方法を学び、機械学習の本質を理解しながら、少しずつスキルを伸ばしていくこと を目指しています。<br>
<br>
<br>
<br>
