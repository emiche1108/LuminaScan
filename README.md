...
中でも特に「データをもとに未来を予測し、業務の最適化に貢献できる」需要予測の面白さに魅了され<br>
「より深くデータを分析し、活用できるようになりたい」という想いが芽生えました。<br>

アプリケーション開発に際して<br>
需要予測の分野に興味がありましたが、個人で開発・検証を進めるには膨大なデータと環境が必要であり、実践が難しいと感じました。<br>
そこで、より身近なテーマでAIを活用し、実際に動くものを作ることで知識を深めよう と考えたのが、肌診断アプリ開発のきっかけです。<br>
