...
前職では、AIを活用した需要予測業務に携わっていました。<br>
データをもとに未来を予測し、業務の最適化に貢献することの面白さに触れ、より深く探求したいという想いが芽生えました。<br>
特に在庫管理に強い関心を持ちましたが、開発面ではアプリの設計だけでなく<br>
精度の検証には膨大なデータと実証環境が必要であり、個人での実施が難しいと感じました。<br>

そこで、比較的情報収集が容易で、AIの分析プロセスを体系的に学べる分野として肌診断アプリの作成に挑戦することにしました。<br>
「AIを活用したシステムを開発し、仕組みを深く理解したい」という想いのもと<br>
実験的な個人プロジェクト としてこのアプリを開発しました。<br>
