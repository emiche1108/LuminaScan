...
前職では、AIを活用した需要予測業務に従事していました。<br>
仕事を通じて「データをもとに未来を予測し、業務の最適化に貢献できる」ことの面白さに気づき、<br>
データを活かして幅広い分野に影響を与えられる可能性に魅了されました。<br>

特に需要予測や適正在庫の管理に関心を持っていましたが、個人で開発・検証を進めるには<br>
膨大なデータと実証環境が必要であり、そのハードルの高さを痛感。<br>
そこで、まずは実践的にAIの仕組みを学べるテーマとして、肌診断アプリの開発を選びました。<br>
この分野を選んだ理由は、比較的情報を集めやすく、AIの分析プロセスを体系的に理解できるからです。<br>

まずは、より実践的にAIの仕組みを学べるテーマとして、肌診断アプリの開発に挑戦することにしました。<br>
比較的情報を集めやすく、AIの分析プロセスを体系的に理解できる分野であることが、その理由です。<br>


「AIを活用したシステムを作り、仕組みを理解したい」<br>
自身の知識を広げると同時に、プログラマーとしての適性を試す 個人プロジェクトとして取り組んでいます。<br>

AIの実践的な活用方法や機械学習モデルの本質を探求し、より深い知識とスキルを身につけることを目指しています。<br>
<br>
<br>
<br>
