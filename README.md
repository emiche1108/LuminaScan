...
前職では、AIを活用した需要予測業務に従事していました。
仕事を通じて 「データをもとに未来を予測し、業務の最適化に貢献できる」 ことの面白さに気づき、
データを活かして幅広い分野に影響を与えられる可能性に魅了されました。

特に需要予測や適正在庫の管理に関心を持っていましたが、個人で開発・検証を進めるには
膨大なデータと実証環境が必要である為、実践するハードルの高さを痛感しました。

まずは、より実践的にAIの仕組みを学べるテーマとして、肌診断アプリの開発に挑戦することにしました。
比較的情報を集めやすく、AIの分析プロセスを体系的に理解できる分野であることが、その理由です。

「AIを活用したシステムを作り、仕組みを理解したい」
自身の勉強と理解度を深める事・プログラマーとしてのセンスと精神があるのかどうかを見極める
個人プロジェクトとして開発を進めています。


AIの実践的な活用方法や機械学習モデルの本質を探求し、より深い知識とスキルを身につけることを目指しています。
<br>
<br>
<br>
