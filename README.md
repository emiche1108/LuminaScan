...
前職ではAIを活用した需要予測業務に携わり、データから未来を予測し、業務の最適化に貢献する面白さを実感しました。<br>
しかし、特に関心のあった在庫管理の需要予測を個人で開発・検証するには、膨大なデータと環境が必要であり、実践するハードルの高さを痛感しました。<br>

そこで、より実践的にAIの仕組みを学べるテーマとして、<br>
肌診断アプリの開発に挑戦しました。比較的情報を集めやすく、AIの分析プロセスを体系的に理解できる分野だったからです。<br>

「まずは自分でAIを活用したシステムを作り、仕組みを深く理解したい」<br>
その想いのもと、実験的な個人プロジェクトとして開発を進めました。<br>
このプロジェクトを通じて、AIの実践的な活用方法や機械学習モデルの本質を探求し、より深い知識とスキルを身につけることを目指しています。
<br>
<br>
<br>
