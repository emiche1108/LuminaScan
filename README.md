...
仕事を通じて「データをもとに未来を予測し、業務の最適化に貢献できる」ことの面白さに気づきました。
データの力を活かして幅広い分野に貢献できることを知り、AI技術への興味が一層深まりました。

特に、需要予測や適正在庫の管理 に関心がありましたが、個人でアプリケーション開発・検証するには
膨大なデータと実証環境が必要であり、実践するハードルの高さを痛感しました。
そこで、より実践的にAIの仕組みを学べるテーマとして、先ずは肌診断アプリの開発に挑戦しました。
このテーマを選んだ理由は、比較的情報を集めやすく、AIの分析プロセスを体系的に理解できるからです。

「まずは自分でAIを活用したシステムを作り、仕組みを深く理解したい」
その想いのもと、実験的な個人プロジェクトとして開発を進めました。
