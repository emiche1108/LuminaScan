...
データの力を活かしてさまざまな分野に影響を与えられる可能性に魅了されました。<br>

特に需要予測や適正在庫の管理に関心を持っていましたが、個人で開発・検証を進めるには<br>
膨大なデータと実証環境が必要であり、開発ハードルの高さを痛感。<br>
そこで、まずは実践的にAIの仕組みを学べるテーマとして、肌診断アプリの開発に挑戦しました。<br>
この分野を選んだ理由は、比較的情報を集めやすく、AIの分析プロセスを体系的に理解しやすいためです。<br>
<br>

「AIを活用したシステムを作り、その仕組みを理解したい」<br>
自身の知識を広げると同時に、プログラマーとしての適性を試す、個人プロジェクトとして取り組みました。<br>

このプロジェクトを通じて、AIの実践的な活用方法や機械学習モデルの本質を探求し、
より深い知識とスキルを身につけることを目指しています。
<br>
<br>
<br>
